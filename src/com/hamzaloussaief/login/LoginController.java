package com.hamzaloussaief.login;

import com.hamzaloussaief.dao.DBConnection;
    ...
    private void onLogin() {
        ...
        switch(status) {
            case 0 :  {
                ...
                Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("/com/hamzaloussaief/system/System.fxml"));
